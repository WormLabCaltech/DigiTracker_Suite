...
void COptionsDlg::OnChangeLsthres() 
{
	...
	// TODO: Add your control notification handler code here
	char buf[10];
	m_lsThresholdEdit.GetLine(0, buf);
...
void COptionsDlg::OnChangeMwpcount() 
{
	...
	// TODO: Add your control notification handler code here
	char buf[10];
	m_mwPixelCountEdit.GetLine(0, buf);
...
void COptionsDlg::OnChangeSaveimages() 
{
	...
	// TODO: Add your control notification handler code here
	char buf[10];
	m_SaveimagesEdit.GetLine(0, buf);
	saveimages=atoi(buf);
}
...
void COptionsDlg::OnChangeFoathreshold() 
{
	...
	// TODO: Add your control notification handler code here
	char buf[10];
	m_foathresholdEdit.GetLine(0, buf);
...
void COptionsDlg::OnChangeBndrythreshold() 
{
	...
	// TODO: Add your control notification handler code here
	char buf[10];
	m_bndrythresholdEdit.GetLine(0, buf);
