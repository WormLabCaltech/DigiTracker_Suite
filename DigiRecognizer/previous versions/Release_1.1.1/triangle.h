...
struct triangulateio {
  REALTRI *pointlist;                                               /* In / out */
  REALTRI *pointattributelist;                                      /* In / out */
  int *pointmarkerlist;                                          /* In / out */
  int numberofpoints;                                            /* In / out */
  int numberofpointattributes;                                   /* In / out */

  int *trianglelist;                                             /* In / out */
  REALTRI *triangleattributelist;                                   /* In / out */
  REALTRI *trianglearealist;                                         /* In only */
  ...
  REALTRI *holelist;                        /* In / pointer to array copied out */
  int numberofholes;                                      /* In / copied out */

  REALTRI *regionlist;                      /* In / pointer to array copied out */
  int numberofregions;                                    /* In / copied out */

  int *edgelist;                                                 /* Out only */
  int *edgemarkerlist;            /* Not used with Voronoi diagram; out only */
  REALTRI *normlist;                /* Used only with Voronoi diagram; out only */
