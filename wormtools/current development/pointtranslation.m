...
%   FIXED: restored FPT decimation.  [Not sure why we disregarded that
%   before, but now we have that implemented.]
...
% Allow user to decimate position data if they really want...  May be a bad
% idea, but that is the user's prerogative!
