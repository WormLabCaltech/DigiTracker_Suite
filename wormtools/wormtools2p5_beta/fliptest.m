...
% 2014-07-01: Matlab introduced a built-in function called 'flip' (as a
% parent of existing built-ins 'flipud' and 'fliplr') which conflicts with
% our wormtools 'flip' function.  Can't seem to make Matlab change their
% function's name so I'm renaming 'flip' to 'fliptest'. CJC
