...
% Establish default 'LineStyles' to help prevent duplicating line colors on
% plots featuring many lines.  At end of function reset to previous state.
% (Default ColorOrder on CJC's development machine is 7 colors, but only
% one line style, '-'.  Setting four line styles allows 7*4=28 distinct
% color/line combinations.)
previousLineStyleOrder = get(0, 'DefaultAxesLineStyleOrder');
...
% Reset default LineStyleOrder
set(0, 'DefaultAxesLineStyleOrder', previousLineStyleOrder);
