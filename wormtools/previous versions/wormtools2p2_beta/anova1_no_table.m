function [p,anovatab,stats] = anova1_no_table(x,group,displayopt,extra)

%ANOVA1_NO_TABLE    Customized One-way analysis of variance (ANOVA) calculation 
%
% Customized version of ANOVA1 that eliminates printing the annoying ANOVA
% data table (~line 274).
%
...
%
%   C. J. Cronin 7-28-06
%   $Revision: 1.01 $  $Date: 2006/07/28 xx:xx:xx $
% 

% r1.01: Initial release of C J Cronin-modified version of ANOVA1.
%   Initially released for use with stats
...
% CJC - Removing this to eliminate printing annoying ANOVA data table: 
% statdisptable(atab, wtitle, ttitle, '', digits);      

% % fig2 = figure('pos',get(gcf,'pos') + [0,-200,0,0]);
% fig2 = figure('pos',get(gcf,'pos') + [0,-25,0,0]);
