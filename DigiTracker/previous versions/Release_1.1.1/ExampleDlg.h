...
protected:
   ...
   DWORD m_restartTime;			 // Start of tracking "restart" event in milliseconds since "system start."
   long	m_settlingTime;			 // Time (in milliseconds) to pause before attempting to track again.
